    ...
    class EventSubscriberDrawer : UnityEditor.Editor
    {
        ...
        private void OnResponseAdded()
        {
            if (GUILayout.Button("Add Response"))
            {
                ...
                var newresponse = responseListProperty.GetArrayElementAtIndex(size);
                newresponse.FindPropertyRelative("currentEvent").objectReferenceValue = null;
                newresponse.FindPropertyRelative("priority").intValue = 0;
