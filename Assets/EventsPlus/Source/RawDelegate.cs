...
{	
	...
	public  class RawDelegate
	{
		...
		public System.Delegate delegateInstance { get; protected set;}
			...
			if ( tMember != null )
			{
				switch ( tMember.MemberType )
				{
					case MemberTypes.Field:
						...
						return typeof( RawDelegate ).GetMethod( "CreateFieldAction", BindingFlags.Static | BindingFlags.NonPublic ).MakeGenericMethod( tempField.ReflectedType, tempField.FieldType ).Invoke( null, new object[] { m_target, tempField } ) as System.Delegate;
					case MemberTypes.Property:
						PropertyInfo tempProperty = tMember as PropertyInfo;
						return Delegate.CreateDelegate( typeof( Action<> ).MakeGenericType( tempProperty.PropertyType ), m_target, tempProperty.GetSetMethod(), false );
					case MemberTypes.Method:
						...
						if ( tempIsAction )
						{
							...
							{
								case 0:
									return Delegate.CreateDelegate( typeof( Action ), m_target, tempMethod, false );
								case 1:
									return Delegate.CreateDelegate( typeof( Action<> ).MakeGenericType( tempParameterTypes ), m_target, tempMethod, false );
								case 2:
									return Delegate.CreateDelegate( typeof( Action<,> ).MakeGenericType( tempParameterTypes ), m_target, tempMethod, false );
								case 3:
									return Delegate.CreateDelegate( typeof( Action<,,> ).MakeGenericType( tempParameterTypes ), m_target, tempMethod, false );
						...
						{
							case 0:
								return Delegate.CreateDelegate( typeof( Func<> ).MakeGenericType( tempParameterTypes ), m_target, tempMethod, false );
							case 1:
								return Delegate.CreateDelegate( typeof( Func<,> ).MakeGenericType( tempParameterTypes ), m_target, tempMethod, false );
							case 2:
								return Delegate.CreateDelegate( typeof( Func<,,> ).MakeGenericType( tempParameterTypes ), m_target, tempMethod, false );
